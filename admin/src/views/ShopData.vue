  ...
  <div id="services-data">
    ...
    <div class="container mb-4">
      <div class="pkg mt-5 shadow">
        <div class="row">
          <div class="col">
            <h4 class="mx-2 my-2 text-right">Modify Shop Content</h4>
          </div>
            ...
            <table class="w-100 table-responsive-md mt-3">
              <thead>
                <tr class="text-center">
                  <th class="px-4" width="15%">Item</th>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="modalFormLabel">Add New Item</h5>
            <button
              type="button"
              class="close"
              data-dismiss="modal"
...
export default {
  ...
  methods: {
    ...
    savePackage() {
      ...
      axios
        .post("http://localhost:3000/api/shop", formData)
        .then((response) => {
    ...
    async deletePackage(id) {
      ...
      if (confirmDelete) {
        try {
          await axios.delete(`http://localhost:3000/api/shop/${id}`);
