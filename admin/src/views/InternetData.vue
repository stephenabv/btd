  ...
  <div id="services-data">
    ...
    <div class="container mb-4">
      <div class="pkg mt-5 shadow">
        <div class="row">
          <div class="col">
            <h4 class="mx-2 my-2 text-right">Internet Packages</h4>
          </div>
...
export default {
  ...
  methods: {
    ...
    savePackage() {
      ...
      axios
        .post("http://localhost:3000/api/internet", formData)
        .then((response) => {
    ...
    async fetchData() {
      try {
        const response = await axios.get("http://localhost:3000/api/internet");
    ...
    async deletePackage(id) {
      ...
      if (confirmDelete) {
        try {
          await axios.delete(`http://localhost:3000/api/internet/${id}`);
